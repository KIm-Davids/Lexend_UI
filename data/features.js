export const panelData = [
  {
    ...
    description:
      "Streamline customer interactions with smart, instant replies. From FAQs to,",
  },
  {
    id: 2,
    ...
    description:
      "Keep your audience engaged with timely, relevant messages. Increase response rates and build lasting relationships with interactive communication",
  },
  {
    id: 3,
    ...
    description:
      "Reach more customers without manual effort. Whether you're sending one message or thousands, Flowwatts ensures smooth, efficient, and impactful messaging at scale.",
  },
];
