export const footerLinks = [
  {
    links: [
      { href: "/page-about", label: "Home" },
      { href: "/page-pricing", label: "Features" },
      { href: "/page-features", label: "Pricing" },
      { href: "/page-integrations", label: "Blog" },
      { href: "/page-career", label: "Contact" },
